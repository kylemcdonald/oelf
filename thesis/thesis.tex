...
\subsection{The I Ching}

	The I Ching as a perfect example of a coherent system.

	The I Ching as an introduction to enumeration of binary sequences.
...
\section{The MP3 Bitstream}

	(This whole section is way too detailed, and needs to be replaced with a general description of which values vary and what their sonic corollaries are. Maybe this should be in the appendix?)
...
\section{Composing for a Large Space}
	...
	(Change ringing/method ringing as a solution to a factorial musical-temporal space based on permutations and swapping.)
