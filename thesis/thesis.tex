...
Sometimes we filter noise with an inapplicable preconceived context, revealing a signal that only temporarily retains coherence. We have an especially strong bias for anthropomorphization: from the face on mars\cite{brian_dunning_facemars_2008} to the CfA2 Great Wall ``stick man''\cite{de_lapparent_slice_1986}.
