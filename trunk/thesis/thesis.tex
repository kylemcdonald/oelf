...
Some seminal empty works include 4'33'' by John Cage\cite{larry_j_solomon_sounds_1998}, Peter Ablinger's work with white noise, Marcel Duchamp's ready-mades, Robert Rauschenberg's white paintings, Kazimir Malevich's early Suprematist work\cite{moma_kazimir_2006}, and Alexander Rodchenko's ``pure'' colors\cite{moma_rodchenko_1998}. While each of these were created in unique historical and artistic situations, they share the common feature of either accepting or representing everything through the presentation of ``nothing''.

Cage accepted all sounds as potential musical material, saying ``Music is continuous. It is only we who turn away''. Similarly, Duchamp accepted all objects as potential sculptural material.

Rauschenberg, Malevich and Rodchenko presented prepared canvases, lacking any subject beyond the materials, construction, and arrangement of the work itself. Malevich reduces painting to its ``essence''---here, the space of painting:
...
Ablinger offers a sonic response, presenting only white noise with no subject beyond the configuration of the speakers themselves:
...
Why were some people so mad at Cage after the first performance of 4'33''? Being presented in the context of a musical performance, he was associating his musical work of silence with the musical work of others. Empty work destroys the artist by elevating the individual. Historically the Western artist has acted as a sort of aesthetic-ubermensch, creating a framework of perception for their audience: a framework rooted in religious interpretation and self-expression, before and after the Renaissance respectively. Without bad faith comes existential angst.\footnote{Sartre, Being and Nothingness} Cage seemed to be somewhat unaware of this effect, saying:
...
Ablinger writes, ``redundancy produces information''\cite{christian_scheib_statics_????} and has some other helpful reflections on the relationship between noise, repetition, and meaning. Christian Scheib writes about Ablinger:
	
	\begin{quote}
	...that each repetition is also variation, that there is necessarily always something changing---that, in other words: repetition does not exist except as an abstraction.
	\end{quote}
	
And Ablinger speaks for himself in the notes for IEAOV:
...
[A tie-in that introduces the difference between ``everything all at once'' and ``enumeration''---the Aleph was somewhere between enumeration and emptiness.] Carlos Argentino Daneri is a writer who discovers the Aleph in his basement, and is using it to produce an epic poem titled ``The Earth'', describing everything in detail. While explaining the structure and content of the poem, he links it to scripture with all of its ``enumeration, congeries, and conglomeration''.
...
[Also, mention this as an extension of the earlier section on everything as ``birth''.]	
