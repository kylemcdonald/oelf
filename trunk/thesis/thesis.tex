...
When I first started working with MP3, I was most amazed by the way the seemingly random pattern of zeros and ones worked together to create a sound. As Brandenburg describes it, ``it's really a miracle with how that is reconstructed to get you the music again''\cite{tom_merritt_real_2010}. Learning the MP3 specification became itself a sonic practice---a metaphor for discovering the context of a previously noisy sound.
